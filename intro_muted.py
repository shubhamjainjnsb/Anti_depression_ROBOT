...
def familytree():
    s.speak(
        "You can be comfortable with me and Tell me more about your family....!Also From now consider me  a part of your family.")
    s.myCommand()
...
def Favourite():
    ...
    if 'yes' in x:
        webbrowser.open(
            "https://www.google.com/maps/search/nearest+ice+cream+parlour+near+me/@28.6883733,77.2892228,14z/data=!3m1!4b1")
...
def talk_in_mind():
    s.speak(
        "do you have anything special in your mind ?please Tell me about it\nMy programmers like one word answer but i hate it!! ?")
    s.myCommand()
